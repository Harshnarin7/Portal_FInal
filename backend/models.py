...
class NeonatalMorbidities(Base):
    ...
    aed_number = Column(String, nullable=True)
    aed_other = Column(String, nullable=True)
    aed_type = Column(JSON, nullable=True)
    ahw = Column(Float, nullable=True)
    eeg_result = Column(String, nullable=True)
    etiology = Column(String, nullable=True)
    etiology_other = Column(String, nullable=True)
    ich_type = Column(String, nullable=True)
    ivh_date_left = Column(Date, nullable=True)
    ivh_date_right = Column(Date, nullable=True)
    ivh_description = Column(String, nullable=True)
    ivh_description_left = Column(String, nullable=True)
    ivh_description_right = Column(String, nullable=True)
    ivh_grade_left = Column(String, nullable=True)
    ivh_grade_right = Column(String, nullable=True)
    ivh_present = Column(String, nullable=True)
    pvl_date_left = Column(Date, nullable=True)
    pvl_date_right = Column(Date, nullable=True)
    pvl_grade_left = Column(String, nullable=True)
    pvl_grade_right = Column(String, nullable=True)
    pvl_present = Column(String, nullable=True)
    tod_max = Column(Float, nullable=True)
    ventriculomegaly_present = Column(String, nullable=True)
    vi_max = Column(Float, nullable=True)

    # ---------------- RESPIRATORY (H2) (added by migrate_neonatal_morbidities) ----------------
    age_steroid = Column(Integer, nullable=True)
    apnea_onset_age = Column(Integer, nullable=True)
    bpd_support_36w = Column(String, nullable=True)
    caffeine_duration = Column(Integer, nullable=True)
    caffeine_used = Column(String, nullable=True)
    cpap = Column(String, nullable=True)
    cpap_used = Column(String, nullable=True)
    extubation_episodes = Column(Integer, nullable=True)
    extubation_failure = Column(String, nullable=True)
    hc_after_first = Column(Boolean, nullable=True)
    hc_after_second = Column(Boolean, nullable=True)
    hc_first_drug = Column(Boolean, nullable=True)
    hfnc = Column(String, nullable=True)
    hfnc_days = Column(Integer, nullable=True)
    hfnc_used = Column(String, nullable=True)
    hydrocortisone_bp = Column(String, nullable=True)
    imv_days = Column(Integer, nullable=True)
    imv_used = Column(String, nullable=True)
    invasive_ventilation = Column(String, nullable=True)
    nasal_cannula = Column(String, nullable=True)
    nasal_cannula_days = Column(Integer, nullable=True)
    nasal_cannula_used = Column(String, nullable=True)
    nippv = Column(String, nullable=True)
    nippv_days = Column(Integer, nullable=True)
    nippv_used = Column(String, nullable=True)
    o2_days = Column(Integer, nullable=True)
    oxygen_exposure = Column(Float, nullable=True)
    pulmonary_hypertension = Column(String, nullable=True)
    rx_ino = Column(Boolean, nullable=True)
    rx_miliri = Column(Boolean, nullable=True)
    rx_other = Column(Boolean, nullable=True)
    rx_other_text = Column(String, nullable=True)
    rx_sildenafil = Column(Boolean, nullable=True)
    rx_vaso = Column(Boolean, nullable=True)
    steroid_dose = Column(Float, nullable=True)
    steroid_drug_other = Column(String, nullable=True)
    steroid_indication_other = Column(String, nullable=True)

    # ---------------- GASTROINTESTINAL (H3) (added by migrate_neonatal_morbidities) ----------------
    age_first_feed = Column(Integer, nullable=True)
    age_full_feeds = Column(Integer, nullable=True)
    age_full_feeds_summary = Column(Integer, nullable=True)
    bifidobacterium = Column(String, nullable=True)
    ebm_days = Column(Integer, nullable=True)
    fi_abdominal_distension = Column(Boolean, nullable=True)
    fi_altered_aspirates = Column(Boolean, nullable=True)
    fi_prefeed_aspirates = Column(Boolean, nullable=True)
    fi_sluggish_bowel = Column(Boolean, nullable=True)
    fm_days = Column(Integer, nullable=True)
    lactobacillus = Column(String, nullable=True)
    nec_age_days = Column(Integer, nullable=True)
    nec_resection = Column(Boolean, nullable=True)
    nec_resection_length = Column(Float, nullable=True)
    nec_stoma = Column(Boolean, nullable=True)
    nec_surgery_type = Column(String, nullable=True)
    pdhm_days = Column(Integer, nullable=True)
    pn_acidosis = Column(Boolean, nullable=True)
    pn_adverse = Column(String, nullable=True)
    pn_cholestasis = Column(Boolean, nullable=True)
    pn_days_summary = Column(Integer, nullable=True)
    pn_electrolyte = Column(Boolean, nullable=True)
    pn_hypercapnia = Column(Boolean, nullable=True)
    pn_other = Column(Boolean, nullable=True)
    pn_other_text = Column(String, nullable=True)
    probiotic = Column(String, nullable=True)
    strain_bi = Column(Boolean, nullable=True)
    strain_mono = Column(Boolean, nullable=True)
    strain_multi = Column(Boolean, nullable=True)
    tpn_associated = Column(String, nullable=True)

    # ---------------- METABOLIC (H4) (added by migrate_neonatal_morbidities) ----------------
    alp_peak = Column(Float, nullable=True)
    dyselectro_ca = Column(Boolean, nullable=True)
    dyselectro_k = Column(Boolean, nullable=True)
    dyselectro_na = Column(Boolean, nullable=True)
    dyselectrolytemia = Column(String, nullable=True)
    hyperglycemia = Column(String, nullable=True)
    hyperglycemia_highest = Column(Float, nullable=True)
    hypoglycemia = Column(String, nullable=True)
    hypoglycemia_lowest = Column(Float, nullable=True)
    lowest_calcium = Column(Float, nullable=True)
    lowest_phosphorus = Column(Float, nullable=True)
    metabolic_acidosis = Column(String, nullable=True)
    osteopenia = Column(String, nullable=True)

    # ---------------- CARDIOVASCULAR (H5) (added by migrate_neonatal_morbidities) ----------------
    dbp = Column(Float, nullable=True)
    fluid_bolus = Column(String, nullable=True)
    fluid_bolus_number = Column(Integer, nullable=True)
    hypotension_both = Column(Boolean, nullable=True)
    hypotension_diastolic = Column(Boolean, nullable=True)
    hypotension_systolic = Column(Boolean, nullable=True)
    inotrope_adr = Column(Boolean, nullable=True)
    inotrope_dobu = Column(Boolean, nullable=True)
    inotrope_dopa = Column(Boolean, nullable=True)
    inotrope_duration = Column(Integer, nullable=True)
    inotrope_milri = Column(Boolean, nullable=True)
    inotrope_nadr = Column(Boolean, nullable=True)
    inotrope_vaso = Column(Boolean, nullable=True)
    pda_both = Column(Boolean, nullable=True)
    pda_bounding_pulse = Column(Boolean, nullable=True)
    pda_clinical = Column(Boolean, nullable=True)
    pda_courses = Column(Integer, nullable=True)
    pda_echo = Column(Boolean, nullable=True)
    pda_hyperactive_precordium = Column(Boolean, nullable=True)
    pda_ibu = Column(Boolean, nullable=True)
    pda_indo = Column(Boolean, nullable=True)
    pda_la_ao = Column(Float, nullable=True)
    pda_ligation_age = Column(Integer, nullable=True)
    pda_lpa_velocity = Column(Float, nullable=True)
    pda_medical_rx = Column(String, nullable=True)
    pda_murmur = Column(Boolean, nullable=True)
    pda_other_feature = Column(Boolean, nullable=True)
    pda_other_feature_text = Column(String, nullable=True)
    pda_pattern_growing = Column(Boolean, nullable=True)
    pda_pattern_none = Column(Boolean, nullable=True)
    pda_pattern_pulsatile = Column(Boolean, nullable=True)
    pda_pcm = Column(Boolean, nullable=True)
    pda_peak_velocity = Column(Float, nullable=True)
    pda_shunt = Column(String, nullable=True)
    pda_systemic_steal = Column(String, nullable=True)
    pda_tdd = Column(Float, nullable=True)
    pda_wide_pp = Column(Boolean, nullable=True)
    sbp = Column(Float, nullable=True)
    structural_heart_disease = Column(String, nullable=True)
    structural_heart_disease_detail = Column(String, nullable=True)
    vis_score = Column(Float, nullable=True)

    # ---------------- HEMATOLOGY (H6) (added by migrate_neonatal_morbidities) ----------------
    anemia = Column(String, nullable=True)
    anemia_chf = Column(String, nullable=True)
    anemia_etiology = Column(String, nullable=True)
    anemia_etiology_other = Column(String, nullable=True)
    anemia_onset = Column(Float, nullable=True)
    bind = Column(String, nullable=True)
    cmv_screened = Column(String, nullable=True)
    dvet = Column(String, nullable=True)
    dvet_number = Column(Integer, nullable=True)
    ffp_cryo = Column(String, nullable=True)
    ffp_number = Column(Integer, nullable=True)
    irradiated = Column(String, nullable=True)
    ivig = Column(String, nullable=True)
    jaundice_etiology = Column(String, nullable=True)
    jaundice_etiology_other = Column(String, nullable=True)
    jaundice_onset = Column(Date, nullable=True)
    jaundice_passive = Column(Date, nullable=True)
    jaundice_type = Column(String, nullable=True)
    lowest_hb = Column(Float, nullable=True)
    peak_tsb = Column(Float, nullable=True)
    phototherapy = Column(String, nullable=True)
    platelet_number = Column(Integer, nullable=True)
    platelets = Column(String, nullable=True)
    prbc = Column(String, nullable=True)
    prbc_number = Column(Integer, nullable=True)
    prbc_volume = Column(Float, nullable=True)

    # ---------------- RENAL (H7) (added by migrate_neonatal_morbidities) ----------------
    aki = Column(String, nullable=True)
    aki_date = Column(Date, nullable=True)
    aki_dialysis = Column(Boolean, nullable=True)
    aki_oliguria = Column(Boolean, nullable=True)
    aki_peak_creatinine = Column(Float, nullable=True)
    aki_stage1 = Column(Boolean, nullable=True)
    aki_stage2 = Column(Boolean, nullable=True)
    aki_stage3 = Column(Boolean, nullable=True)

    # ---------------- OPHTHALMOLOGY / ROP (H7) (added by migrate_neonatal_morbidities) ----------------
    rop = Column(String, nullable=True)
    rop_anti_vegf = Column(Boolean, nullable=True)
    rop_arop = Column(String, nullable=True)
    rop_bilateral = Column(String, nullable=True)
    rop_comment = Column(String, nullable=True)
    rop_diagnosis_date = Column(Date, nullable=True)
    rop_first_screen_date = Column(Date, nullable=True)
    rop_laser = Column(Boolean, nullable=True)
    rop_method_ido = Column(Boolean, nullable=True)
    rop_method_retcam = Column(Boolean, nullable=True)
    rop_other = Column(Boolean, nullable=True)
    rop_other_text = Column(String, nullable=True)
    rop_plus = Column(String, nullable=True)
    rop_screened = Column(String, nullable=True)
    rop_stage1 = Column(Boolean, nullable=True)
    rop_stage2 = Column(Boolean, nullable=True)
    rop_stage3 = Column(Boolean, nullable=True)
    rop_stage4 = Column(Boolean, nullable=True)
    rop_stage5 = Column(Boolean, nullable=True)
    rop_treatment = Column(String, nullable=True)
    rop_vitrectomy = Column(Boolean, nullable=True)
    rop_zone1 = Column(Boolean, nullable=True)
    rop_zone2 = Column(Boolean, nullable=True)
    rop_zone3 = Column(Boolean, nullable=True)

    # ---------------- THERMOREGULATION (H8) (added by migrate_neonatal_morbidities) ----------------
    hyperthermia = Column(String, nullable=True)
    hyperthermia_clothing = Column(Boolean, nullable=True)
    hyperthermia_equipment = Column(Boolean, nullable=True)
    hyperthermia_location_dr = Column(Boolean, nullable=True)
    hyperthermia_location_nicu = Column(Boolean, nullable=True)
    hyperthermia_location_transport = Column(Boolean, nullable=True)
    hyperthermia_other = Column(Boolean, nullable=True)
    hyperthermia_other_text = Column(String, nullable=True)
    hyperthermia_probe = Column(Boolean, nullable=True)
    hyperthermia_temp = Column(Float, nullable=True)
    hyperthermia_wrap = Column(Boolean, nullable=True)
    hypothermia = Column(String, nullable=True)
    hypothermia_environment = Column(Boolean, nullable=True)
    hypothermia_immaturity = Column(Boolean, nullable=True)
    hypothermia_ivh = Column(Boolean, nullable=True)
    hypothermia_location_dr = Column(Boolean, nullable=True)
    hypothermia_location_nicu = Column(Boolean, nullable=True)
    hypothermia_location_transport = Column(Boolean, nullable=True)
    hypothermia_lowest_temp = Column(Float, nullable=True)
    hypothermia_mild = Column(Boolean, nullable=True)
    hypothermia_moderate = Column(Boolean, nullable=True)
    hypothermia_other = Column(Boolean, nullable=True)
    hypothermia_other_text = Column(String, nullable=True)
    hypothermia_sepsis = Column(Boolean, nullable=True)
    hypothermia_severe = Column(Boolean, nullable=True)

    # ---------------- VASCULAR ACCESS (H9) (added by migrate_neonatal_morbidities) ----------------
    arterial_posterior_tibial = Column(Boolean, nullable=True)
    arterial_radial = Column(Boolean, nullable=True)
    extravasation = Column(String, nullable=True)
    line_comp_infection = Column(Boolean, nullable=True)
    line_comp_none = Column(Boolean, nullable=True)
    line_comp_thrombosis = Column(Boolean, nullable=True)
    peripheral_arterial = Column(String, nullable=True)
    peripheral_venous = Column(String, nullable=True)
    picc = Column(String, nullable=True)
    picc_days = Column(Integer, nullable=True)
    uac = Column(String, nullable=True)
    uac_days = Column(Integer, nullable=True)
    uvc = Column(String, nullable=True)
    uvc_days = Column(Integer, nullable=True)

    # ---------------- INFECTION (H10) totals (added by migrate_neonatal_morbidities) ----------------
    vap_episodes = Column(Integer, nullable=True)

    # ---------------- HOSPITAL COURSE (H12) (added by migrate_neonatal_morbidities) ----------------
    back_referral_hospital = Column(String, nullable=True)
    back_referral_other = Column(String, nullable=True)
    designation = Column(String, nullable=True)
    discharge_hc = Column(Float, nullable=True)
    total_los = Column(Integer, nullable=True)

    # dynamic Infection (H10) episode list
    infections = Column(JSON, nullable=True)
