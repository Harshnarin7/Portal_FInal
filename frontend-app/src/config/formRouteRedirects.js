...
export const ENROLLMENT_ID_FORM_REDIRECTS = [
  ...
  { basePath: "/fio2-auc", currentForm: "fio2_auc", label: "Helper 2 (FiO₂ AUC)" },
  { basePath: "/vs6-1", currentForm: "vs6_1", label: "Helper 1 (Resp/CV/Neuro)" },
  { basePath: "/infect-gi-hema-log", currentForm: "infect_gi_hema", label: "Helper 3" },
  { basePath: "/metab-renal-vasc-eye-log", currentForm: "metab_renal_vasc_eye", label: "Helper 4" },
  { basePath: "/minimal-monitoring", currentForm: "minimal_monitoring", label: "Helper 5" },
