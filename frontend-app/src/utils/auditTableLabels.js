...
export const AUDIT_TABLE_LABELS = {
  ...
  fio2_auc_logs: "Helper 2 — FiO₂ AUC",
  resp_cv_neuro_day_logs: "Helper 1 — Resp/CV/Neuro (daily)",
  infect_gi_hema_day_logs: "Helper 3 — Infect/GI/Hema (daily)",
  metab_renal_vasc_eye_day_logs: "Helper 4 — Metab/Renal/Eye (daily)",
  minimal_monitoring_day_logs: "Helper 5 — Minimal Monitoring",
